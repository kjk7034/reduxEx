...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2.default.createElement(_reactRedux.Provider, { store: store }, _react2.default.createElement(_App2.default, null)), document.getElementById('tabSample'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReducersSample = (0, _redux.combineReducers)({
	    Reducer1: _reducer2.default
	});

	exports.default = ReducersSample;
	    ...
	    switch (action.type) {
	        case 'Tab_State':
	            return Object.assign({}, state, {
	                ...
	                datas: _sample2.default.items[action.text]
	            });
	        default:
	            return Object.assign({}, state, {
	                tabIndex: 0,
	                datas: _sample2.default.items[0]
	            });
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TabSample = __webpack_require__(194);

	var _TabSample2 = _interopRequireDefault(_TabSample);

	var _InitTabState = __webpack_require__(202);

	var _InitTabState2 = _interopRequireDefault(_InitTabState);
	...
	var App = function App() {
	    return _react2.default.createElement('div', null, _react2.default.createElement(_TabSample2.default, null), _react2.default.createElement(_InitTabState2.default, null));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TabList = __webpack_require__(196);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        onTabClick: function onTabClick(tabIndex) {
	            dispatch((0, _actions.TabState)(tabIndex));
	        }
	    };
	};

	var TabSample = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_TabList2.default);

	exports.default = TabSample;
...
/***/ function(module, exports) {
	...
	var Tab_State = exports.Tab_State = "Tab_State";

	function TabState(text) {
	    return {
	        type: Tab_State,
	        text: text
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TabContents = __webpack_require__(200);
	...
	var TabList = function TabList(_ref) {
	    var tabState = _ref.tabState;
	    var datas = _ref.datas;
	    var onTabClick = _ref.onTabClick;
	    return _react2.default.createElement('div', null, _react2.default.createElement('h1', null, 'Tab Sample'), _react2.default.createElement('ul', { className: 'tabList' }, _react2.default.createElement('li', { className: tabState == 0 ? "on" : "off" }, _react2.default.createElement('a', { href: '#', onClick: function onClick() {
	            return onTabClick(0);
	        } }, 'Tab1')), _react2.default.createElement('li', { className: tabState == 1 ? "on" : "off" }, _react2.default.createElement('a', { href: '#', onClick: function onClick() {
	            return onTabClick(1);
	        } }, 'Tab2')), _react2.default.createElement('li', { className: tabState == 2 ? "on" : "off" }, _react2.default.createElement('a', { href: '#', onClick: function onClick() {
	            return onTabClick(2);
	        } }, 'Tab3'))), _react2.default.createElement(_TabContents2.default, { datas: datas }));
	};
	//TabList.propTypes = {
	...
	module.exports = {
		"items": [
			[
				...
				{
					"name": "제목 1-2",
					"desc": "오늘은 날씨가 좋습니다.!!!! 오늘은 날씨가 좋습니다.!!!! 오늘은 날씨가 좋습니다.!!!!"
				},
				{
					"name": "제목 1-3",
					"desc": "오늘은 날씨가 좋습니다.!!!! 오늘은 날씨가 좋습니다.!!!! 오늘은 날씨가 좋습니다.!!!! 오늘은 날씨가 좋습니다.!!!! 오늘은 날씨가 좋습니다.!!!!"
				}
			],
			[
				{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TabContents = function TabContents(_ref) {
	    var datas = _ref.datas;
	    return _react2.default.createElement("div", { className: "tabContentsList" }, datas.map(function (items, key) {
	        return _react2.default.createElement("div", { key: key }, _react2.default.createElement("h2", { className: "title" }, items.name), _react2.default.createElement("div", { className: "desc" }, items.desc));
	    }));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InitButton = function InitButton(_ref) {
	    var onInitClick = _ref.onInitClick;
	    return _react2.default.createElement("div", null, _react2.default.createElement("button", { type: "button", onClick: onInitClick }, "초기화"));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InitButton = __webpack_require__(201);

	var _InitButton2 = _interopRequireDefault(_InitButton);
	...
	var initButtonProps = function initButtonProps(dispatch) {
	    var _unsubscribe = unsubscribe;
	    return {
	        onInitClick: function onInitClick() {
	...
	var InitTabState = (0, _reactRedux.connect)(null, initButtonProps)(_InitButton2.default);

	exports.default = InitTabState;
